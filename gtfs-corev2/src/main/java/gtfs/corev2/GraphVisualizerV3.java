...
public class GraphVisualizerV3 extends JPanel {
	...
	public GraphVisualizerV3(String appTitle, String pathToDataset, Target target) {
    	...
    	if (target == Target.LOCAL) {
    		g = 
    			new GTFSGraphBuilder(pathToDataset)
            	.localDataset()
            	.build();
    	} else {
    		g = 
		...
		MouseWheelListener wheelTracker = new MouseWheelListener()
		{
			...
			public void mouseWheelMoved(MouseWheelEvent e)
			{
				if (e.getSource() instanceof mxGraphOutline
						|| e.isControlDown())
				{
					GraphVisualizerV3.this.mouseWheelMoved(e);
				}
			}
	...
	public Action bind(String name, final Action action, String iconUrl)
	{
		AbstractAction newAction = new AbstractAction(name, (iconUrl != null) ? new ImageIcon(
				GraphVisualizerV3.class.getResource(iconUrl)) : null)
		{
			public void actionPerformed(ActionEvent e)
			{
